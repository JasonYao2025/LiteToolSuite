...
namespace LiteToolSuite
{
    public partial class FrmMqtt : Form
    {
        ...
        public FrmMqtt()
        {
            ...
            #region 动态切换语言
            //labelAIDevice.Location = new Point(labelVehicleName.Left - 10, labelVehicleName.Top + 30);
            //labelAIModel.Location = new Point(labelVehicleName.Left - 10, labelVehicleName.Top + 30);
            //LanguageHelper.SetLang(FrmLogin.CultureCode, this, typeof(FrmMqttUploadLog));  //根据FrmLogin.CultureCode 显示对应语言
            #endregion
        ...
        private void btnConnectMqttServer_Click(object sender, EventArgs e)
        {
            ...
            ResourceManager rm = new ResourceManager("LiteToolSuite.FrmMqttUploadLog", Assembly.GetExecutingAssembly());
        ...
        private Task _mqttClient_ApplicationMessageReceivedAsync(MqttApplicationMessageReceivedEventArgs arg)
        {
            ...
            LogHelper.WriteLogToFile("log.txt", text);
